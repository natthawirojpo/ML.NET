...
namespace Movie
{
    class Program
    {
        private static string TrainingDataLocation = 
            @"E:\ml\recommendation-ratings-train.csv";
        private static string TestDataLocation = 
            @"E:\ml\recommendation-ratings-test.csv";
        ...
        static void Main(string[] args)
        {
            ...
            IDataView trainingDataView = mlcontext.Data.LoadFromTextFile<MovieRating>
                (TrainingDataLocation, hasHeader: true, separatorChar: ',');
            ...
            var predictionengine = mlcontext.Model.CreatePredictionEngine
                <MovieRating, MovieRatingPrediction>(model);
            ...
            // show result using a helper class
            Movie movieService = new Movie();
            Console.WriteLine();
            Console.WriteLine("=============== Make a single movie rating prediction ===============");
            Console.WriteLine("For userId:" + predictionuserId + 
                " movie rating prediction (1 - 5 stars) for movie:" + 
                movieService.Get(predictionmovieId).movieTitle + " is:" + 
